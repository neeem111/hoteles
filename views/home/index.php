...
<body>
    ...
    <header class="header">
        <h1><?php echo htmlspecialchars($nombreCadena); ?></h1>
        <p>Vive el lujo en los mejores destinos de España. ¡Tu escapada perfecta comienza aquí!</p>
    </header>
                ...
                <?php foreach ($hoteles as $hotel): ?>
                    <div class="hotel-card">
                        ...
                        <div class="hotel-content">
                            ...
                            <a href="index.php?page=hotel&hotel_id=<?php echo $hotel['Id']; ?>" class="btn-reserve">
                                Ver Habitaciones
                            </a>
                        </div>
                    </div>
    ...
    <footer class="footer">
        <p>&copy; <?php echo date("Y"); ?> <?php echo htmlspecialchars($nombreCadena); ?>. | <a href="index.php?page=aviso_legal">Aviso Legal</a> | <a href="contacto.php">Contáctanos</a></p>
    </footer>
